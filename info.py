...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002659186869').split()]
...
FILE_CHANNELS = [int(ch) for ch in environ.get('FILE_CHANNELS', '-1002684551966').split()]
